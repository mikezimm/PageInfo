...
export function aboutTable( repoLinks: IRepoLinks, showRepoLinks: boolean ) {
    ...
    table.rows.push( createAboutRow('2022-07-xx',"1.0.1.09?","Standarize Code:  #95, #96, #97, #98, #99", showRepoLinks === true ? repoLinks : null ) );
    table.rows.push( createAboutRow('2022-07-xx',"1.0.1.09?","Standarize Code:  #85, #86, #87, #88, #89, #90, #91, #93, #94", showRepoLinks === true ? repoLinks : null ) );
