...
export const panelVersionNumber = '2022-05-16 -  1.0.0.06'; //Added to show in panel
...
export function aboutTable( repoLinks: IRepoLinks, showRepoLinks: boolean ) {
    ...
    table.rows.push( createAboutRow('2022-05-16',"1.0.0.06","#39 - Move core HelpPanel component code to import npmFunctions, #40, #41", showRepoLinks === true ? repoLinks : null ) );
