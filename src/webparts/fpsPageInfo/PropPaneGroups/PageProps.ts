...
export function pagePropertiesGroup( wpProps: IFpsPageInfoWebPartProps, availableProperties: IPropertyPaneDropdownOption[], thisFromWP: any ) {
  ...
  const group : IPropertyPaneGroup = {
    ...
    isCollapsed: true,
    groupFields: getPagePropFields( wpProps, availableProperties, thisFromWP ),
  }; //End this group;
...
function getPagePropFields( wpProps: IFpsPageInfoWebPartProps, availableProperties: IPropertyPaneDropdownOption[], thisFromWP: any ) {
